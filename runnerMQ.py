...
class Rabbit:
    def __init__(self):
        ...
        self.channel.queue_declare(queue='runner')        #self.channel.exchange_declare(exchange='direct')
    ...
    def receive(self):
        ...
        self.channel.basic_consume(queue='runner',
...
def main():
    ...
    while True:
        ...
        if len(responses) > 0:
            order = responses[0]
            rabbit.send("runner: running "+order)
